...
class SchedulingExperiment:
    ...
    def _compute_stats(self) -> None:
        ...
        """
        un_trucks = self.fleet.num_trucks() - self.fleet.num_nonempty_trucks()
        self._stats = {
            'fleet': self.fleet.num_trucks(),
            'unused_trucks': un_trucks,
    ...
    def _print_report(self) -> None:
        ...
        print(self._stats['fleet'])
        print(self._stats['unused_trucks'])
        print(self._stats['avg_distance'])
        print(self._stats['avg_fullness'])
        print(self._stats['unused_space'])
        print(self._stats['unscheduled'])
